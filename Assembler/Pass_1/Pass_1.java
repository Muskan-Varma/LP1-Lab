...
public class Pass_1 {
    ...
    public void generateIC() throws Exception {
        BufferedWriter wr=new BufferedWriter(new FileWriter("C:\\Users\\DELL\\Desktop\\LP-1\\Assembler\\Pass_1\\ic.txt"));
        BufferedReader br=new BufferedReader(new FileReader("C:\\Users\\DELL\\Desktop\\LP-1\\Assembler\\Pass_1\\in.asm"));
        String line=" ";
        pooltab.add(0, 0);
        wr.write("---------------------\n  Intermediate Code\n---------------------\n");
        ...
        wr.flush();
        BufferedReader icr=new BufferedReader(new FileReader("C:\\Users\\DELL\\Desktop\\LP-1\\Assembler\\Pass_1\\ic.txt"));   
        while(icr.ready()){  
        System.out.print((char)icr.read());  
        }  
        icr.close();
        wr.close();
        BufferedWriter br1=new BufferedWriter(new FileWriter("C:\\Users\\DELL\\Desktop\\LP-1\\Assembler\\Pass_1\\sym.txt"));
        br1.write("-------------------\n    Symbol Table\n-------------------\nSymbol    Address\n");
        for(int i=0;i<symtab.size();i++) {
            br1.write("  "+symtab.get(i)+"       "+symaddr.get(i)+"\n");
        }
        br1.flush();
        BufferedReader br1r=new BufferedReader(new FileReader("C:\\Users\\DELL\\Desktop\\LP-1\\Assembler\\Pass_1\\sym.txt"));   
        while(br1r.ready()){  
        System.out.print((char)br1r.read());  
        }  
        br1r.close();
        br1.close();
        BufferedWriter br2=new BufferedWriter(new FileWriter("C:\\Users\\DELL\\Desktop\\LP-1\\Assembler\\Pass_1\\lit.txt"));
        br2.write("-----------------------\n    Literal Table\n-----------------------\nLiteral       Address\n");
        for(int i=0;i<littab.size();i++) {
            br2.write("='"+littab.get(i)+"'           "+litaddr.get(i)+"\n");
        }
        br2.flush();
        BufferedReader br2r=new BufferedReader(new FileReader("C:\\Users\\DELL\\Desktop\\LP-1\\Assembler\\Pass_1\\lit.txt"));   
        while(br2r.ready()){  
        System.out.print((char)br2r.read());  
        }  
        br2r.close();
        br2.close();
        BufferedWriter br3=new BufferedWriter(new FileWriter("C:\\Users\\DELL\\Desktop\\LP-1\\Assembler\\Pass_1\\pool.txt"));
        BufferedReader br3r=new BufferedReader(new FileReader("C:\\Users\\DELL\\Desktop\\LP-1\\Assembler\\Pass_1\\pool.txt"));   
