...
public class Pass_2 {
	...
	public static void main(String[] args) {
		...
		try {
			pass2.generateCode("C:\\Users\\DELL\\Desktop\\LP-1\\Assembler\\Pass_2\\IC.txt");
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	public void readtables()
	{
		...
		try
		{
			br=new BufferedReader(new FileReader("C:\\Users\\DELL\\Desktop\\LP-1\\Assembler\\Pass_2\\SYMTAB.txt"));
			...
			br.close();
			br=new BufferedReader(new FileReader("C:\\Users\\DELL\\Desktop\\LP-1\\Assembler\\Pass_2\\LITTAB.txt"));
			while((line=br.readLine())!=null)
			{
				String parts[]=line.split("\\s+");
	...
	public void generateCode(String filename) throws Exception
	{
		...
		BufferedWriter bw=new BufferedWriter(new FileWriter("C:\\Users\\DELL\\Desktop\\LP-1\\Assembler\\Pass_2\\PASS2.txt"));
		String line,code;
		while((line=br.readLine())!=null)
		{
			String parts[]=line.split("\\s+");
